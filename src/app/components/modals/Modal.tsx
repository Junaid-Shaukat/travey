      ...
      >
        ...
        >
          ...
          <div
            ...
            `}
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col items bg-white outline-none focus:outline-none">
              {/* header */}
